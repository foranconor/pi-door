...
module.exports = "<div style=\"text-align:center; padding-top:100px;\" class=\"container\">\n    <h2 class=\"display-3\" >Garage Door</h2>\n    <div class=\"form-group\">\n        <label for=\"pwd\">Password:</label>\n        <input class=\"form-control text-center\" id=\"pwd\" type=\"password\"\n               required\n               [(ngModel)]=\"password\" name=\"password\">\n    </div>\n    <button class=\"btn btn-primary btn-lg\"\n            type=\"button\"\n            name=\"button\"\n            (click)=\"open()\">Open</button>\n</div>\n"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.open = function () {
        ...
        this.http.get(url + 'nonce').subscribe(function (nDat) {
            var hash = __WEBPACK_IMPORTED_MODULE_2_crypto_js__["SHA3"](_this.password + nDat.nonce).toString();
            console.log(hash);
            var body = { key: hash };
            console.log(body);
            _this.http.post(url + 'door', body).subscribe(function (dDat) {
                console.log('success');
            }, function (dErr) {
